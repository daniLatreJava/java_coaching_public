...
We tend to use 160 columns for a balance between fewer continuation lines but still easily
...
Check this out: [Why Are Trailing Whitespaces Bad](http://www.dinduks.com/why-are-trailing-whitespaces-bad)
...
Avoid embedding the field type in the field name.
    ...
    String nameListSizeStr;
    int nameListSize = Integer.parse(nameListSizeStr);
...
#### Don't document overriding methods (usually)
    ...
    class TwitterDatabase implements Database {
       ...
       *
       * @return The database version in [semver](http://semver.org) format.
       */
      @Override
      public String getVersion() {
        ...
